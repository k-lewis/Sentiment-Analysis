function [net, info] = books_main_routine(varargin)
%CNN_Book Review: Demonstrates training 
...
opts.dataPath = fullfile(opts.dataDir,'data_book.mat');
...
for k=1:10
    ...
    net = cnn_sa_Dag_v3(); % initialize the network
